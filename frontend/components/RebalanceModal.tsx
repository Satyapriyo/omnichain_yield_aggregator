...
interface RebalanceModalProps {
    ...
    onRebalance: (fromStrategy: PublicKey, toStrategy: PublicKey, amount: number) => Promise<void>
}
...
export function RebalanceModal({
    ...
    const availableStrategies = strategies.filter(
        s => s.publicKey.toString() !== currentStrategy?.publicKey.toString() && s.isActive
    )
                    ...
                    <div>
                        ...
                        >
                            ...
                            {availableStrategies.map((strategy) => (
                                <option key={strategy.publicKey.toString()} value={strategy.publicKey.toString()}>
